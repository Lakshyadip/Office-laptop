...
public class Training {
	...
	public static void main(String[] args) {
		...
		ckc8.click();
	    WebElement next8= driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next8.click();
	    WebElement ckc9=mywait.until(ExpectedConditions.elementToBeClickable((By.xpath("(//div[@class='option'])[2]"))));
		ckc9.click();
	    WebElement next9 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next9.click();
		...
		ckc11.click();
	    WebElement next11 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next11.click();
		...
		ckc13.click();
	    WebElement next13 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next13.click();
		...
		ckc22.click();
	    WebElement next22 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next22.click();
	    WebElement ckc23=mywait.until(ExpectedConditions.elementToBeClickable((By.xpath("(//div[@class='option'])[2]"))));
		ckc23.click();
	    WebElement next23 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next23.click();
	    WebElement ckc24=mywait.until(ExpectedConditions.elementToBeClickable((By.xpath("(//div[@class='option'])[2]"))));
		ckc24.click();
	    WebElement next24 = driver.findElement(By.xpath("(//button[normalize-space()='Next'])[1]"));
	    next24.click();
	    WebElement ckc25=mywait.until(ExpectedConditions.elementToBeClickable((By.xpath("(//div[@class='option'])[2]"))));
		ckc25.click();
	    WebElement next25 = driver.findElement(By.xpath("(//button[normalize-space()='Submit'])[1]"));
	    next25.click();
	    driver.quit();
